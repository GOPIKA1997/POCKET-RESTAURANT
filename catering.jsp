...
$(document).ready(function() {
		...
		$.getJSON("catering_json.jsp?curr_date="+curr_date+"&status1=catering", function(json){
			...
			while(i<len)
				{
					...
					$("#approveHeadingRow").append('<tr><td>'+(i+1)+'</td><td>'+name+'</td><td>'+addr+'</td><td>'+phone+'</td><td><a href="catering_more.jsp?userreg_id='+userreg_id+'&buy_id='+buy_id+'"><input type="submit" value="VIEW" id="view" class="btn btn-danger btn-sm" ></a></td></tr>');
